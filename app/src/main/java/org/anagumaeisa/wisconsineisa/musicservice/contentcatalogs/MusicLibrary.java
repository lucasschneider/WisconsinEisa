...
import org.anagumaeisa.wisconsineisa.BuildConfig;
    ...
    static {
        for (int i = 0; i < MusicCatalog.size(); i++) {
            createMediaMetadataCompat(
                    MusicCatalog.getSong(i).getMediaId(),
                    MusicCatalog.getSong(i).getTitle(),
                    MusicCatalog.getSong(i).getArtist(),
                    MusicCatalog.getSong(i).getAlbumJp(),
                    MusicCatalog.getSong(i).getGenre(),
                    MusicCatalog.getSong(i).getSec(),
                    MusicCatalog.getSong(i).getMp3(),
                    MusicCatalog.getSong(i).getDrawable(),
                    MusicCatalog.getSong(i).getAlbumArtResName()
            );
        }
    }
        ...
        music.put(
                ...
                new MediaMetadataCompat.Builder()
                        ...
                        .putLong(MediaMetadataCompat.METADATA_KEY_DURATION,
                                TimeUnit.MILLISECONDS.convert(sec, TimeUnit.SECONDS))
